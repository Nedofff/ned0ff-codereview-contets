...
export const AdvertisingCard = ({
  ...
  return (
    <Card
      className={cn(
        "gradient-secondary-light grid grid-cols-[auto_max-content] grid-rows-2 items-center max-h-51",
        className
      )}
    >
      <p className="font-wix-display text-lg font-bold leading-[22px] lg:text-[22px] lg:leading-[24px] ">
        {children}
      </p>
