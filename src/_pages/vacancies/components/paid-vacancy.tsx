...
export const MtsCard = () => (
  <PaidVacancyCard
    ...
    remote
    salary="15000"
    bgImageDesktop="/vacancies/mts-desktop.webp"
    bgImageMobile="/vacancies/mts-mobile.webp"
    isMTS
  />
);
export const AvitoCard = () => (
  <PaidVacancyCard
    ...
    internship
    salary={null}
    bgImageDesktop="/vacancies/avito-desktop.webp"
    bgImageMobile="/vacancies/avito-mobile.webp"
  />
);
export const KpokCard = () => (
  <PaidVacancyCard
    ...
    internship
    salary={null}
    bgImageDesktop="/vacancies/kpok-desktop.webp"
    bgImageMobile="/vacancies/kpok-mobile.webp"
  />
);
