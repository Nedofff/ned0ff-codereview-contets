...
export const getVacanciesApiBackend = (getAuthToken: GetAuthToken) =>
  new VacanciesApi(getBackendClient(getAuthToken));

export const getVacanciesApiNext = (getAuthToken: GetAuthToken = () => null) =>
  new VacanciesApi(getNextApi(getAuthToken));
